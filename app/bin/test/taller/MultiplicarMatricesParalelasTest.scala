...
class MultiplicarMatricesParalelasTest extends AnyFunSuite {
    val objMultiMatpar = new MultiplicarMatricesParalelas() // Instancia del objeto que multiplica matrices
