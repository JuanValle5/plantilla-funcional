...
class MultiplicarMatricesRecParalelasTest extends AnyFunSuite {
    val objMultiMatrecpar = new MultiplicarMatricesRecParalelas() // Instancia del objeto que multiplica matrices
