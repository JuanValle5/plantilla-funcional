...
class MultiplicarMatricesTest extends AnyFunSuite {

  val objMultiMat = new MultiplicacionMatrices() // Instancia del objeto que multiplica matrices
  ...
  test("Multiplicar matrices secuencial 2x2 - Caso 1") {
    ...
    assert(objMultiMat.getMatrizResultado(matriz1, matriz2) === resultadoEsperado)
  }
